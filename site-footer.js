  ...
  footer.innerHTML = `
    ...
    <div class="site-footer-bottom">
      ...
      <div class="site-footer-socials" aria-label="Social media">
        ...
        <a class="discord" href="https://discord.com" target="_blank" rel="noopener" aria-label="Discord">${icon('<path d="M7 7c3-1.5 7-1.5 10 0 1.5 2 2.2 4.2 2.4 7-2 1.5-3.4 2-4.8 2.3l-1.1-1.4M17 7l-1-2M7 7 8 5M9 13h.1M15 13h.1M9 17c2 .8 4 .8 6 0"/>')}</a>
        <a class="instagram" href="https://instagram.com" target="_blank" rel="noopener" aria-label="Instagram">${icon('<rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1"/>')}</a>
        ...
        <a class="twitter" href="https://x.com" target="_blank" rel="noopener" aria-label="X">${icon('<path d="M18 3h3l-6.6 7.5L22 21h-6l-4.7-6.1L6 21H3l6.9-7.9L2.6 3h6.1l4.2 5.6L18 3Zm-1 16h1.7L7.8 4.9H6L17 19Z"/>')}</a>
        <a class="tiktok" href="https://tiktok.com" target="_blank" rel="noopener" aria-label="TikTok">${icon('<path d="M14 4v11.2a4.2 4.2 0 1 1-3.6-4.2M14 4c.5 3 2.2 4.5 5 4.8"/>')}</a>
      </div>
